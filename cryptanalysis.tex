...
blocks $i-1$ and $j-1$.  \comment{notation probably needs to be explained, maybe back up in Intro, or where block ciphers are explained.}
...
half hour, and you're good. \comment{Tie this to intro, IPsec and TLS.}
