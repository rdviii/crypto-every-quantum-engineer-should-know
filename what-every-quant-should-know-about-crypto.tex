...
and potential deployment of quantum technology.  Quantum researchers
...
\item When will quantum computers be able to effectively attack:
  ...
  \item bulk data encryption itself; and
  \item blockchain?
  \end{itemize}
...
response~\cite{needham:large-net-auth}, or it can be done via
