...
\item What is the response of the classical cryptographic community to
...
\item a full survey of the massive amounts of clever research done in
  ...
  (e.g.,~\cite{kimmel,buhrman14:_posit_based_quant_crypt,ben-or2005fast,crepeau:_secur_multi_party_qc});
...
\comment{bitcoiin here or elsewhere?  Blockchain is an \emph{auditable
